...
insert into customers (username, name, enabled, password) values ('keith', 'Keith',true,'417c7382b16c395bc25b5da1398cf076');
insert into customers (username, name, enabled, password) values ('erwin', 'Erwin',true,'12430911a8af075c6f41c6976af22b09');
insert into customers (username, name, enabled, password) values ('jeremy', 'Jeremy',true,'57c6cbff0d421449be820763f03139eb');
insert into customers (username, name, enabled, password) values ('scott', 'Scott',true,'942f2339bf50796de535a384f0d1af3e');
insert into customers (username, name, enabled, password) values ('josh', 'Josh',true,'c9089f3c9adaf0186f6ffb1ee8d6501c');
