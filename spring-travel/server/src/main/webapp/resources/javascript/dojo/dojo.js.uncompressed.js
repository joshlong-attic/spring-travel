                    ...
                    _core: {
                        ...
                        _findMixin: function(mixin) {
                            ...
                            while (c) {
                                ...
                                if (m && m._findMixin && (m = m._findMixin(mixin))) {
                                    return m;
                                }
                                c = p && p.constructor;
                            }
...
// =============================
            ...
            dojo.extend(dojo.NodeList, {
                        ...
                        query: function(/*String*/ queryStr) {
                            ...
                            this.forEach(function(item) {
                                ...
                                ret = ret.concat(d.query(queryStr, item).filter(function(subItem) {
    ...
    if (!dojo._hasResource["dojo._base.xhr"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
        ...
        (function() {
            ...
            _d._ioWatch = function(/*Deferred*/dfd, /*Function*/validCheck, /*Function*/ioCheck, /*Function*/resHandle) {
...
// ported from dojo.html.util
        ...
        dijit.placeOnScreen = function(/* DomNode */            node, /* dijit.__Position */    pos, /* String[] */            corners, /* boolean? */            tryOnly) {
            //	summary:
...
// fill the queue
    ...
    if (!dojo._hasResource["dijit._base.scroll"]) { //_hasResource checks added by build. Do not use _hasResource directly in your code.
        ...
        dijit.scrollIntoView = function(/* DomNode */node) {
            ...
            for (var dir in scrollRoot._renderedSize) {
                scrollRoot._renderedSize[dir] = Math.min(scrollRoot._clientSize[dir], scrollRoot._renderedSize[dir]);
            }
            var element = node;
            while (element != scrollRoot) {
                ...
                for (dir in element._start) { // for both x and y directions
                    ...
                    if (parent._clientSize[dir] == 0) { // TABLE on Safari3/FF3, and TBODY on IE6/7
                        ...
                        if (rtl && dir == "H") {
                            parent._start[dir] -= parent._renderedSize[dir];
                        }
                    } else {
...
//				console.debug("parse of date format, pattern=" + pattern);
        ...
        dojo.date.locale.getNames = function(/*String*/item, /*String*/type, /*String?*/use, /*String?*/locale) {
            ...
            if (use == 'standAlone') {
                ...
                if (label[0] == 1) {
                    label = undefined;
                } // kludge, in the absense of real aliasing support in dojo.cldr
            }
            props[1] = 'format';
                ...
                if (typeof cont == "string") {
                    ...
                    switch (name) {
                        case 'tr':
                            ...
                            walk += 1;//fallthrough
                        case 'tbody':
                        case 'thead':// children of THEAD is of same type as TBODY
                            pre = '<tbody>' + pre;
                            post += '</tbody>';
                            walk += 1;// falltrough
                        case 'table':
